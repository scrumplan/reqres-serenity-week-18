...
public class UsersCRUDTest extends TestBase {
    ...
    static String email = "lindsay.ferguson@reqres.in";
    static String password = "monkeymika";
    ...
    @Test
    public void test002() {
        HashMap<String, Object> userMap = usersSteps.getProductInfoByName(userID);
    ...
    @Title("This will delete  user by deleted")
    @Test
    public void test006() {
